...
export default class ApiClient {
  ...
  // GET
  public static get<T = any>(url: string, options?: CustomRequestOptionsOmit) {
    return this.http<T>({
      url,
      method: 'GET',
      ...options
  ...
  // POST
  public static post<T = any>(url: string, options?: CustomRequestOptionsOmit) {
    return this.http<T>({
      url,
      method: 'POST',
      ...options
  ...
  // PUT
  public static put<T = any>(url: string, options?: CustomRequestOptionsOmit) {
    return this.http<T>({
      url,
      method: 'PUT',
      ...options
  ...
  // DELETE
  public static delete<T = any>(url: string, options?: CustomRequestOptionsOmit) {
    return this.http<T>({
      url,
      method: 'DELETE',
      ...options
